...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'sakana', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '如果停止思考，就等同于死亡', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yuyu0506.top', // 网站地址
